...
- Started 2026-09-15: Phase 0 done; Phases 1A/1B PARKED mid-flight on branch `wip/a10b` (pushed) when the user's usage ran low — resume there (see `.claude/PLAN-A10b.md` §6; 1A stopped inside panes.ts with editor-pane.ts written, 1B inside dnd.ts resolve()). Main is clean at A9.

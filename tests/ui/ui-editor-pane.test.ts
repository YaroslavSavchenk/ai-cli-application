 ...
 * the DOM double in `tests/helpers/fake-dom.ts`, against the REAL `web/src/state.ts`,
 * `ui/util.ts`, `ui/dnd.ts`, `ui/slots-model.ts`, `ui/editor-model.ts`,
 * `ui/file-pane.ts` — with the two backends plain fakes
 * (`tests/helpers/editor-fixture.ts` for the files, `tests/helpers/fs-fixture.ts` for git).
 *
 * WHY THIS FILE EXISTS, next to `tests/ui/ui-pane-a10.test.ts`. That file is a
...
// seam `tests/ui/ui-file-pane.test.ts` and `tests/ui/ui-dnd-a10.test.ts` use.
// ---------------------------------------------------------------------------

 ...
 * guards (`tests/ui/ui-a8-dialogs.test.ts`, `tests/ui/ui-a8-chrome.test.ts`,
 * `tests/ui/ui-a7-parity.test.ts`) ask "does the stylesheet mention this class
...
import { APP_CSS, frontendFiles, stripComments } from '../helpers/tokens-helpers.ts';
 ...
 * `tests/ui/ui-a8-dialogs.test.ts` reads, plus the template-literal form, so a
 ...
 * `tests/ui/ui-a7-parity.test.ts` covers `sg-/ap-/gh-/pk-`, `ui-a8-dialogs`

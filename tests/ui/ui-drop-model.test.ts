 ...
 * answer.
 *
 * This file: A9's rules and the sweeps over every sentence they build (the
 * sweeps read what the tests above them collected, so they stay in one file).
 * Part B10's rules — the ones the REAL copy reads — are in
 * `tests/ui/ui-drop-model-b10.test.ts`.
 *

 ...
 * pinned next door: `tests/ui/ui-shortcuts-table.test.ts`,
 * `tests/ui/ui-shortcuts-openers.test.ts`, `tests/ui/ui-update-model.test.ts`,
 * `tests/ui/ui-restart-guards.test.ts`, `tests/ui/ui-restart-log-hold.test.ts`.
 */
 ...
 * them. Their own DOM behaviour is `tests/ui/ui-a9-drop-dialog.test.ts`,
 * `tests/ui/ui-files-delete.test.ts` and `tests/ui/ui-unsaved.test.ts`.
 */

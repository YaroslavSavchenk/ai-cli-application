 ...
 *
 * tests/server/github.test.ts covers (a) the not-configured HTTP paths and (b) the
 ...
 * spawn itself is covered by the spawn-seam tests in tests/server/github.test.ts.
 */

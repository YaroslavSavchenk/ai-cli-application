 ...
 * (`tests/ui-update-model.test.ts`, `tests/ui-restart-guards.test.ts`) and the
 * looks are pinned by source scan (`tests/ui-a8-dialogs.test.ts`,
 * `tests/ui-settings-releases.test.ts`). Between the two sits the thing A8
